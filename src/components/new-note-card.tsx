          ...
          <form className="flex-1 flex flex-col">
            <div className="flex flex-1 flex-col gap-3 p-5">
              ...
              {shouldShowOnboarding ? (
                <p className="text-sm/6 text-slate-400">
                  Comece <button type="button" onClick={handleStartRecording} className="text-medium text-lime-400 hover:underline">gravando uma nota</button> em aúdio ou se preferir <button type="button" onClick={handleStartEditor} className="text-medium text-lime-400 hover:underline">utilize apenas texto.</button>
                </p>
              ) : (
                <textarea
                  autoFocus
